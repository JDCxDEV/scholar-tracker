...
export default {
	...
	methods: {
		...
		sortIcon(value, type = 'others') {
            if(this.orderColumn == value) {
                return  this.getSortIcon(type, this.order);
            }
            return 'fas fa-filter';
        },

        getSortIcon(type, order) {
            switch (type) {
                case 'number':
                    return order ? "fas fa-sort-numeric-up-alt" : "fas fa-sort-numeric-down-alt";
                case 'letter':
                    return order ? "fas fa-sort-alpha-up-alt" : "fas fa-sort-alpha-down-alt";
                default:
                    return order ? "fas fa-sort-amount-up-alt" : "fas fa-sort-amount-down-alt";
            }
        },
