<template>
    ...
    <div class="row my-flex-card">
        <div class="col-lg-3 col-sm-6">
            <div class="card card-gray card-outline">
                <div class="card-header">
                    Scholar Account Settings
                </div>
                <div class="card-body text-center">
                    <div class="row mb-2 justify-content-center">
                        <div class="col-md-8">
                            <button type="button" class="btn btn-block btn-main" data-toggle="modal" data-target="#qr-modal">QR Code Settings</button>
                        </div>
                    </div>
                    <div class="row mb-2 justify-content-center">
                        <div class="col-md-8">
                            <button type="button" class="btn btn-block btn-main" data-toggle="modal" data-target="#user-information-modal">Edit Scholar Information</button>
                        </div>
                    </div>
                    <div class="row mb-2 justify-content-center">
                        <div class="col-md-8">
                            <button type="button" class="btn btn-block btn-main" data-toggle="modal" data-target="#scholar-analytics-modal">View Scholar Analytics</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-3 col-sm-6">
             <div class="card card-gray card-outline">
                <div class="card-header">
                    <strong>Today SLP Information</strong>
                </div>
                <div class="card-body">
                    <div class="row mb-3">
                        <div class="col-md-4 pr-0"><b>Adventure</b></div>
                        <div class="col-md-3"><b>:</b> <span class="ml-2 badge badge-secondary">{{ user.adventure_slp ? user.adventure_slp : 0 }}</span></div>
                        <div class="col-md-5"><b>:</b> <span class="ml-2 badge badge-secondary">{{ covertPrice(user.adventure_slp, 'smooth-love-potion', '$') }}</span></div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-4 pr-0"><b>Arena</b></div>
                        <div class="col-md-3"><b>:</b> <span class="ml-2 badge badge-secondary">{{ user.arena_slp ? user.arena_slp : 0 }}</span></div>
                        <div class="col-md-5"><b>:</b> <span class="ml-2 badge badge-secondary">{{ covertPrice(user.arena_slp, 'smooth-love-potion', '$') }}</span></div>
                     </div>
                    <div class="row mb-3">
                        <div class="col-md-4 pr-0"><b>Today</b></div>
                        <div class="col-md-3"><b>:</b> <span class="ml-2 badge badge-secondary">{{ user.computed_today_slp ? user.computed_today_slp : 0 }}</span></div>
                        <div class="col-md-5"><b>:</b> <span class="ml-2 badge badge-secondary">{{ covertPrice(user.computed_today_slp, 'smooth-love-potion', '$') }}</span></div>
                     </div>
                </div>
             </div>
        </div>
        <div class="col-lg-3 col-sm-6">
            <div class="card card-gray card-outline">
                <div class="card-header">
                    <strong>Overall SLP Information</strong>
                </div>
                <div class="card-body">
                    <div class="row mb-3">
                        <div class="col-md-3 pr-0"><b>Ingame</b></div>
                        <div class="col-md-4"><b>:</b> <span class="ml-2 badge badge-secondary">{{ user.ingame_slp ? user.ingame_slp : 0 }}</span></div>
                        <div class="col-md-5"><b>:</b> <span class="ml-2 badge badge-secondary">{{ covertPrice(user.ingame_slp, 'smooth-love-potion', '$') }}</span></div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-3 pr-0"><b>Ronin</b></div>
                        <div class="col-md-4"><b>:</b> <span class="ml-2 badge badge-secondary">{{ user.ronin_slp ? user.ronin_slp : 0 }}</span></div>
                        <div class="col-md-5"><b>:</b> <span class="ml-2 badge badge-secondary">{{ covertPrice(user.ronin_slp, 'smooth-love-potion', '$') }}</span></div>
                     </div>
                    <div class="row mb-3">
                        <div class="col-md-3 pr-0"><b>Total</b></div>
                        <div class="col-md-4"><b>:</b> <span class="ml-2 badge badge-secondary">{{ user.total_slp ? user.total_slp : 0 }}</span></div>
                        <div class="col-md-5"><b>:</b> <span class="ml-2 badge badge-secondary">{{ covertPrice(user.total_slp, 'smooth-love-potion', '$') }}</span></div>
                     </div>
                </div>
            </div>
        </div>
        <div class="col-lg-3 col-sm-6">
            <div class="card card-gray card-outline">
                <div class="card-header">
                    <strong>Scholar Requirements</strong>
                </div>
                <div class="card-body">
                    <div class="row mb-3">
                        <div class="col-md-4 pr-0"><b>Slp a day</b></div>
                        <div class="col-md-6"><b>:</b> <span class="ml-2 badge badge-secondary">{{ user.daily }}</span></div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-4 pr-0"><b>Slp a month</b></div>
                        <div class="col-md-6"><b>:</b> <span class="ml-2 badge badge-secondary">{{ user.monthly }}</span></div>
                     </div>
                    <div class="row mb-3">
                        <div class="col-md-4 pr-0"><b>Pecentage</b></div>
                        <div class="col-md-7"><b>:</b>
                            <template v-if="user.manager_share != 'N/A' || user.manager_share != 'N/A'">
                                <span class="ml-2 badge badge-secondary">Manager ({{ user.manager_share }}%) - Scholar ({{ user.scholar_share }}%)</span>
                            </template>
                             <template v-else>
                                <span class="ml-2 badge badge-secondary">N/A</span>
                             </template>
                        </div>
                     </div>
                </div>
    ...
    <div class="row">
        <div class="col-md-3 text-center h-100">
            <div class="card user-card card-custom card-gray card-outline">
                <div class="card-header custom-header">
                    <h5>Scholar</h5>
                </div>
                <div class="card-block">
                    <div class="user-image">
                        <img src="https://bootdey.com/img/Content/avatar/avatar7.png" class="img-radius border border-secondary" alt="User-Profile-Image">
                    </div>
                    <h6 class="f-w-800 m-t-25 m-b-10">{{ user.first_name }} {{ user.last_name}}</h6>
                    <p class="f-w-800">{{ user.name ? user.name : '-' }}</p>
                    <hr>
                <b class="text-dark m-t-15">Ranking ({{ user.rank ? user.rank : 0 }})</b>
                <div class="bg-c-dark counter-block m-t-10 p-20">
                    <div class="row">
                        <div class="col-3 p-0">
                            <i class="fas fa-trophy text-warning"></i>
                            <p>{{ user.win ? user.win : 0 }}</p>
                            <p class="p-0">win</p>
                        </div>
                        <div class="col-3 p-0">
                            <i class="fas fa-trophy text-danger"></i>
                            <p>{{ user.lose ? user.lose : 0 }}</p>
                            <p class="p-0">lose</p>
                        </div>
                        <div class="col-3 p-0">
                            <i class="fas fa-trophy"></i>
                            <p>{{ user.draw ? user.draw : 0 }}</p>
                            <p class="p-0">draw</p>
                        </div>
                        <div class="col-3 p-0">
                            <i class="fa fa-suitcase"></i>
                            <p>{{ user.elo ? user.elo : 0 }}</p>
                            <p>mmr</p>
                        </div>
                    </div>
                </div>
                <div class="row justify-content-center user-social-link mt-4">
    ...
    <template v-if="user_axies.length">
            ...
            <div class="card card-custom bg-white border-white border-0">
                <div class="card-custom-img" :style="'background-image: url(' + data.image + ');'"></div>
                    ...
                    <div class="card-id" >
                        <div class="div">
                            <h4>
                                <span class="badge badge-dark badge-pill text-white pb-2 pt-2">
                                    # {{ data.id }}
                                </span>
                            </h4>
                        </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12 text-center center-name">
                                <h4>
                                    <span class="badge badge-pill text-white pb-2 pt-2" :style="getBackgroundColor(data.class)">
                                        {{ data.name }}
                                    </span>
                                </h4>
                            </div>
                        ...
                        <div class="row mt-2">
                            <div class="col-md-3 text-center">
                                <h4>
                                    <svg height="30" viewBox="0 0 16 16" style="fill: var(--color-gray-3);"><g><path d="M8 12.394s-4.98-1.626-4.98-5.152A2.72 2.72 0 018 5.73a2.72 2.72 0 014.98 1.512c0 3.526-4.98 5.152-4.98 5.152" fill="#3ac279"></path></g></svg>
                                    <b>{{ data.stats.hp }}</b>
                                </h4>
                            </div>
                            <div class="col-md-3 text-center">
                                <h4>
                                    <svg height="30" viewBox="0 0 16 16" style="fill: var(--color-gray-3);"><g><path d="M9.488 6.85h.96c.16 0 .253.184.157.312L6.56 12.666c-.126.159-.381.047-.349-.154l.697-3.96a.195.195 0 00-.194-.23h-.808a.198.198 0 01-.194-.231l.958-5.009a.197.197 0 01.193-.16h3.586c.135 0 .23.134.183.262L9.305 6.581a.197.197 0 00.183.268" fill="#f7ac0a"></path></g></svg>
                                    <b>{{ data.stats.speed }}</b>
                                </h4>
                            </div>
                            <div class="col-md-3 text-center">
                                <h4>
                                    <svg height="30" viewBox="0 0 16 16" style="fill: var(--color-gray-3);"><g><path d="M11.374 9.463c-.093.308-.15 3.015-.394 3.205-.246.19-2.677-.59-2.98-.59-.303 0-2.734.78-2.98.59-.245-.19-.302-2.897-.395-3.205-.093-.307-1.54-2.533-1.445-2.84.093-.307 2.488-1.201 2.735-1.39.244-.19 1.782-2.346 2.085-2.346.302 0 1.84 2.155 2.085 2.345.246.19 2.642 1.084 2.735 1.391.095.307-1.352 2.533-1.446 2.84" fill="#6a3ac2"></path></g></svg>
                                    <b>{{ data.stats.skill }}</b>
                                </h4>
                            </div>
                            <div class="col-md-3 text-center">
                                <h4>
                                    <svg height="30" viewBox="0 0 16 16" style="fill: var(--color-gray-3);"><g><path d="M11.177 9.139c0 .132-.009.261-.023.39-.176 1.959-1.5 3.263-3.336 3.263-1.781 0-3.017-1.232-3.33-3.106a3.407 3.407 0 01-.046-.547l.012-.229c.043-.771.39-1.577.909-2.087l.363-.358.024.509c.012.236.128.458.337.642.107.094.365.195.676.195.161 0 .314-.028.442-.08a.596.596 0 00.397-.532c.023-.325-.107-.486-.272-.69-.184-.226-.413-.507-.534-1.13-.15-.778.287-1.514 1.23-2.073l.482-.285-.146.54a.995.995 0 00-.032.213c-.02.567.444 1.273 1.417 2.157 1.242 1.13 1.419 2.14 1.423 2.98l.007.228z" fill="#c23a3a"></path></g></svg>
                                    <b>{{ data.stats.morale }}</b>
                                </h4>
                            </div>
                        </div>
                        <hr>
                        <template v-if="data.stage > 1">
                            <div class="row genes">
                                <div class="col-md-4 text-center" :style="getTextColor('text-arctic')">
                                    D
                                </div>
                                <div class="col-md-4 text-center" :style="getTextColor('text-arctic')">
                                    R1
                            ...
                            <div class="row genes">
                                <template v-for="(part, index) in data.traits.eyes">
                                    <div v-if="part" :key="data.id + '-' + index + '-'+ part.id" class="col-md-4 text-center p-0" :style="getTextColor(part.class)">
                                        {{ part.name }}
                                    </div>
                                </template>
                            </div>
                            <div class="row genes">
                                <template v-for="(part, index) in data.traits.mouth">
                                    <div v-if="part.name" :key="data.id + '-' + index + '-'+ part.id" class="col-md-4 text-center p-0" :style="getTextColor(part.class)">
                                        {{ part.name }}
                                    </div>
                                </template>
                            </div>
                            <div class="row genes">
                                <template v-for="(part, index) in data.traits.ears">
                                    <div v-if="part.name" :key="data.id + '-' + index + '-'+ part.id" class="col-md-4 text-center p-0" :style="getTextColor(part.class)">
                                        {{ part.name }}
                                    </div>
                                </template>
                            ...
                            <div class="row genes">
                                <template v-for="(part, index) in data.traits.horn">
                                    <div v-if="part.name" :key="data.id + '-' + index + '-'+ part.id" class="col-md-4 text-center p-0" :style="getTextColor(part.class)">
                                        {{ part.name }}
                                    </div>
                                </template>
                            ...
                            <div class="row genes">
                                <template v-for="(part, index) in data.traits.back">
                                    <div v-if="part.name" :key="data.id + '-' + index + '-'+ part.id" class="col-md-4 text-center p-0" :style="getTextColor(part.class)">
                                        {{ part.name }}
                                    </div>
                                </template>
                            ...
                            <div class="row genes">
                                <template v-for="(part, index) in  data.traits.tail">
                                    <div v-if="part.name" :key="data.id + '-' + index + '-'+ part.id" class="col-md-4 text-center p-0" :style="getTextColor(part.class)">
                                        {{ part.name }}
                                    </div>
                                </template>
                    ...
                    <div class="card-footer" style="background: inherit; border-color: inherit;">
                        <button @click="getSkill(data, data.abilities)" data-toggle="modal" data-target="#exampleModal"  type="button" class="btn btn-block-rounded btn-dark text-white"><i class="fas fa-skull ml-1"></i> Show Cards</button>
                        <button  type="button" class="btn btn-dark btn-block-rounded text-white"><i class="text-warning fas fa-star ml-1"></i> Get Rarity</button>
                    </div>
                </div>
            </div>
        </template>
        ...
        <template v-else>
            <div class="col-sm-9 h-100 my-auto text-center">
        ...
        <axie-view :all_axies="axie" :parts="parts"></axie-view>
...
import AxieView from './AxieView.vue'
...
export default {
    ...
    data() {
        return {
            ...
            url : {
                user_axies_team : `https://api.lunaciaproxy.cloud/_axies/`,
                user_stats : `https://axie-proxy.secret-shop.buzz/_basicStats/`,
                user_slp : `https://axiesworld.firebaseapp.com/updateSpecific?wallet=`,
            }
        }
    },
    ...
    methods: {
        getAxieData(type, address) {
            switch (type) {
                case 'basic_stats':
                    /* get basic stats data of specified address */
                    return this.fetchApiData(address, this.url.basic_stats);
                case 'scholar_earnings':
                    /* get earnings data of specified addresss */
                    return this.fetchApiData(address, this.url.scholar_earnings);
                case 'axies':
                    /* get available axies of specified address */
                    return this.fetchApiData(address, this.url.user_axies_team);
                default:
                    break;
            }
        },

        fetchApiData(address, url) {
            ...
            instance({
                ...
                let data = response.data.available_axies.results;
                if(response.data.available_axies.total) {
                    this.getAxieStats(data);
                }
            }).catch(error =>{
                console.log(error)
            }).then(()=>{
        ...
        async getAxieStats(data) {
            ...
            const posts = data.map(post => {
                return instance.get(`https://api.axie.technology/getgenes/${post.id}/all`)
                .then(res => res.data)
            ...
            Promise.all(posts).then(res => {
                this.has_stats = true;
                this.user_axies = res.map((item,i)=>{
                    if(item.id === data[i].id){
                        this.loading = false;
                        item.purity = this.getPurity(item);
                        item.abilities = item.parts;
        ...
        initData(data) {
            let address = this.cleanString(data.ronin_address);
            if(address) {
                this.init = true;
                this.getAxieData('axies', address);
            }
        },
        ...
        getPurity(data) {
            if(data.stage > 1) {
                ...
                for (let i in parts) {
                    if (data.traits[parts[i]].d.class == data.class.toLowerCase()) {
                        quality += PROBABILITIES.d;
                        dPureness++;
                    }
                    if (data.traits[parts[i]].r1.class == data.class.toLowerCase()) {
                        quality += PROBABILITIES.r1;
                    }
                    if (data.traits[parts[i]].r2.class == data.class.toLowerCase()) {
                        quality += PROBABILITIES.r2;
                    }
                }
                quality =  (quality/MAX_QUALITY) * 100
        ...
        getLabelColor(value) {
            if(value) {
                return 'fill: var(--color-' + value.toLowerCase() + ');'
            }
        },
        getBorderColor(value) {
            if(value) {
                return 'border-color: var(--color-' + value.toLowerCase() + ');'
            }
        },
        getBackgroundColor(value) {
            if(value) {
                return 'background-color: var(--color-' + value.toLowerCase() + ');'
            }
        },

        getTextColor(value) {
            if(value) {
                return 'color: var(--color-' + value.toLowerCase() + ');'
            }
        },

        getSkill(axie, parts) {
            this.parts = parts.filter(part => part.abilities.length);
            this.axie = [axie];
        },

        cleanString(address) {
            address = address.replace(/[^a-zA-Z^[0-9]]/g, "");
