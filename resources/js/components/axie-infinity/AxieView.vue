...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" style="max-width: 1500px !important;" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Axie Cards</h5>
            ...
            <div class="modal-body">
                <div class="row  my-flex-card">
                    <template v-if="all_axies.length">
                        <div  v-for="(data, index) in all_axies" :key="data.id + '-stats-' + index" class="col-md-3 text-center">
                        ...
                        <div  v-for="(data, index) in all_axies" :key="data.id + '-stats-' + index" class="col-md-4 text-center">
                            <div class="card card-custom bg-white border-white border-0">
                                    <div class="card-body">
                                        <div class="row mb-2">
                ...
                <div class="row">
                    <template v-if="parts.length" v-for="part in parts">
                        <div class="col-md-3 mb-3">
                            <div class="maintxt text-white ml-5" :style="'background-image:url('+ part.abilities[0].backgroundUrl +')'">
                                <div class="row">
                                    <div class="col-md-12 mt-3 energy-column">
                                        <p>
                                            <b>
                                                <span class="energy-label">{{ part.abilities[0].energy }}</span>
                                                <span class="ability-label">{{ part.abilities[0].name }}</span>
                                            </b>
                                        </p>
                                    </div>
                                </div>
                                <div class="row mt-2">
                                    <div class="col-md-12 h-100">
                                        <div class="w-full">
                                            <img class="w-full" style="top: 50%;
                                            left: 50%;
                                            transform: translate(-50%, 10%);
                                            width: 20%;" src="../../../images/axie-cards/bg-beast.png">
                                            <div class="absolute w-2/3" style="top: 20%;
                                            left: 0;
                                            transform: translate(-8%, 10%);
                                            width: 20%;
                                            position: absolute;">
                                            <img class="w-full"  style="width: 60%;" src="../../../images/axie-cards/icon-atk.png"></div>
                                            <div class="absolute w-full overflow-hidden text-center font-game" style="position:absolute; top: 60%; left: 5; transform: translate(-50%, -50%); text-shadow: rgb(131, 21, 43) -2px 0px, rgb(131, 21, 43) 0px 2px, rgb(131, 21, 43) 2px 0px, rgb(131, 21, 43) 0px -2px; font-size: 20.5128px;">{{ part.abilities[0].attack }}</div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mt-2">
                                    <div class="col-md-12">
                                        <div class="w-full">
                                            ...
                                            width: 20%;
                                            position: absolute;">
                                            <img class="w-full"  style="width: 60%;" src="../../../images/axie-cards/icon-def.png"></div>
                                            <div class="absolute w-full overflow-hidden text-center font-game" style="position:absolute; top: 60%; left: 5; transform: translate(-50%, -50%); text-shadow: rgb(131, 21, 43) -2px 0px, rgb(131, 21, 43) 0px 2px, rgb(131, 21, 43) 2px 0px, rgb(131, 21, 43) 0px -2px; font-size: 20.5128px;">{{ part.abilities[0].defense }}</div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-2">
                                        <img :src="part.abilities[0].effectIconUrl" class="img-fluid img-effect" alt="Responsive image">
                                    </div>
                                    <div class="col-md-9">
                                        <b>
                                            <p class="ability-description">{{ part.abilities[0].description }}</p>
                                        </b>
                                    </div>
                                </div>
                            </div>
