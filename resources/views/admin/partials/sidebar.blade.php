    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                @if ($self->hasAnyPermission(['admin.users.crud', 'admin.scholar-types.crud']))
                    <li class="nav-item has-treeview {{ $checker->route->areOnRoutes([
                            'admin.users.index','admin.users.create','admin.users.show',
                            'admin.scholar-types.index','admin.scholar-types.create','admin.scholar-types.show',
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            @endif
                        @if ($self->hasAnyPermission(['admin.scholar-types.crud']))
                            <li class="nav-item">
                                <a href="{{ route('admin.scholar-types.index') }}" class="nav-link {{ $checker->route->areOnRoutes([
                                    'admin.scholar-types.index','admin.scholar-types.create','admin.scholar-types.show',
                                ]) }}">
                                    <i class="nav-icon far fa-circle"></i>
                                    <p>
