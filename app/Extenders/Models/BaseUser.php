...
class BaseUser extends Authenticatable
{
    ...
    {
        if (!count($columns)) {
            $columns = ['first_name', 'last_name', 'email', 'mobile_number', 'ronin_address', 'metamask_address'];
        }
        ...
        if ($item->isRoleEditable() && method_exists($item, 'roles') && $request->filled('role_ids')) {
